...
part 'posts/post_event.dart';
part 'posts/post_state.dart';
...
class PostBloc extends Bloc<PostEvent, PostState> {
  ...
  // PostBloc will yield whenever there is a new state
  @override
  ...
  // jsonplaceholder is an online REST API which serves fake datas
